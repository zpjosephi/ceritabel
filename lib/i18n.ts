...
const ID: Dict = {
  ...
  reportHighlights: "Sorotan",
  reportCleaning: "Pembersihan yang diterapkan",
  reportStrongCorr: "Hubungan terkuat",
  reportNoStrong: "Tidak ada korelasi kuat (|r| >= 0.5).",
  reportDirPos: "searah",
  reportDirNeg: "berlawanan arah",
  reportReg: "Regresi linear (OLS)",
  reportPanelModels: "Model panel (Pooled / FE / RE)",
  reportRegNote: "Model default: {y} dijelaskan oleh semua kolom numerik lain.",
...
const EN: Dict = {
  ...
  reportCleaning: "Cleaning applied",
  reportStrongCorr: "Strongest relationships",
  reportNoStrong: "No strong correlations (|r| >= 0.5).",
  reportDirPos: "same direction",
  reportDirNeg: "opposite directions",
  reportReg: "Linear regression (OLS)",
  reportPanelModels: "Panel models (Pooled / FE / RE)",
  reportRegNote: "Default model: {y} explained by every other numeric column.",
